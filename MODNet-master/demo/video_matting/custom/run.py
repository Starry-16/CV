...
if __name__ == '__main__':
    ...
    parser.add_argument('--video', type=str, required=False, default='../../../doc/input/video/1.mp4', help='input video file')
    ...
    modnet.eval()
    print(os.path.splitext(args.video)[0])

    # out_put = string.replace('../../../doc/input/video/', "")

    out_put = os.path.splitext(args.video)[0].split('/')[-1]
    result = '../../../doc/result/video/' + out_put + '_{0}.mp4'.format(args.result_type)
